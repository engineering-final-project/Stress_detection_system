...
image2=Image.open("./img/img5.jpg")
...
l=tk. Label(root,text='Email',font=('Cambria',14)).place(x=10,y=180)
new_password_entry=tk.Entry(root,width=40,textvariable=email).place(x=200,y=180)


l=tk. Label(root,text='New Password',font=('Cambria',14)).place(x=10,y=250)
new_password_entry=tk.Entry(root,width=40,textvariable=password).place(x=200,y=250)

l=tk. Label(root,text='Confirm Password',font=('Cambria',14,)).place(x=10,y=315)
confirm_password_entry=tk.Entry(root,width=40,show="*",textvariable=confirmPassword).place(x=200,y=319)
